...
To run the code and dataset files, please decompress the project.zip 
...
In a world where litterature has changed a lot, it seemed interesting to see if how well a literary work is written influences its popularity or if it is up to completely other factors. (in this project i assume that how well a text is written is measured by its linguistical complexity) 
...
To be sure that my results are not mere correlations, I also test if:  
